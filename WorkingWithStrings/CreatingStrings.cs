...
namespace WorkingWithStrings
{
    public static class CreatingStrings
    {
        ...
        public static string ReturnStringWithRepeatedChars(char c, int count)
        {
            ...
            return new string(c, count: count);
        }
        ...
        {
            // #2-2. Implement the method using String(Char, Int32) constructor
        ...
        {
            // #2-3. Implement the method using String(Char, Int32) constructor
            ...
            return new string(c, startIndex: startIndex, length: length);
        }
    }
}
